...
module Computer_System_mm_interconnect_5 (
	...
	wire    [7:0] video_in_subsystem_video_in_dma_master_translator_avalon_universal_master_0_readdata;      // Video_In_Subsystem_video_in_dma_master_agent:av_readdata -> Video_In_Subsystem_video_in_dma_master_translator:uav_readdata
	...
	wire    [0:0] video_in_subsystem_video_in_dma_master_translator_avalon_universal_master_0_byteenable;    // Video_In_Subsystem_video_in_dma_master_translator:uav_byteenable -> Video_In_Subsystem_video_in_dma_master_agent:av_byteenable
	...
	wire    [7:0] video_in_subsystem_video_in_dma_master_translator_avalon_universal_master_0_writedata;     // Video_In_Subsystem_video_in_dma_master_translator:uav_writedata -> Video_In_Subsystem_video_in_dma_master_agent:av_writedata
	wire    [0:0] video_in_subsystem_video_in_dma_master_translator_avalon_universal_master_0_burstcount;    // Video_In_Subsystem_video_in_dma_master_translator:uav_burstcount -> Video_In_Subsystem_video_in_dma_master_agent:av_burstcount
	wire          rsp_mux_src_valid;                                                                         // rsp_mux:src_valid -> Video_In_Subsystem_video_in_dma_master_agent:rp_valid
	wire   [74:0] rsp_mux_src_data;                                                                          // rsp_mux:src_data -> Video_In_Subsystem_video_in_dma_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                         // Video_In_Subsystem_video_in_dma_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [0:0] rsp_mux_src_channel;                                                                       // rsp_mux:src_channel -> Video_In_Subsystem_video_in_dma_master_agent:rp_channel
	wire          rsp_mux_src_startofpacket;                                                                 // rsp_mux:src_startofpacket -> Video_In_Subsystem_video_in_dma_master_agent:rp_startofpacket
	wire          rsp_mux_src_endofpacket;                                                                   // rsp_mux:src_endofpacket -> Video_In_Subsystem_video_in_dma_master_agent:rp_endofpacket
	...
	wire  [102:0] onchip_sram_s1_agent_rf_source_data;                                                       // Onchip_SRAM_s1_agent:rf_source_data -> Onchip_SRAM_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] onchip_sram_s1_agent_rsp_fifo_out_data;                                                    // Onchip_SRAM_s1_agent_rsp_fifo:out_data -> Onchip_SRAM_s1_agent:rf_sink_data
	...
	wire          video_in_subsystem_video_in_dma_master_agent_cp_valid;                                     // Video_In_Subsystem_video_in_dma_master_agent:cp_valid -> router:sink_valid
	wire   [74:0] video_in_subsystem_video_in_dma_master_agent_cp_data;                                      // Video_In_Subsystem_video_in_dma_master_agent:cp_data -> router:sink_data
	wire          video_in_subsystem_video_in_dma_master_agent_cp_ready;                                     // router:sink_ready -> Video_In_Subsystem_video_in_dma_master_agent:cp_ready
	wire          video_in_subsystem_video_in_dma_master_agent_cp_startofpacket;                             // Video_In_Subsystem_video_in_dma_master_agent:cp_startofpacket -> router:sink_startofpacket
	wire          video_in_subsystem_video_in_dma_master_agent_cp_endofpacket;                               // Video_In_Subsystem_video_in_dma_master_agent:cp_endofpacket -> router:sink_endofpacket
	...
	wire          onchip_sram_s1_agent_rp_valid;                                                             // Onchip_SRAM_s1_agent:rp_valid -> router_001:sink_valid
	wire  [101:0] onchip_sram_s1_agent_rp_data;                                                              // Onchip_SRAM_s1_agent:rp_data -> router_001:sink_data
	wire          onchip_sram_s1_agent_rp_ready;                                                             // router_001:sink_ready -> Onchip_SRAM_s1_agent:rp_ready
	wire          onchip_sram_s1_agent_rp_startofpacket;                                                     // Onchip_SRAM_s1_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          onchip_sram_s1_agent_rp_endofpacket;                                                       // Onchip_SRAM_s1_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire   [74:0] cmd_mux_src_data;                                                                          // cmd_mux:src_data -> Onchip_SRAM_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                                                         // Onchip_SRAM_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [0:0] cmd_mux_src_channel;                                                                       // cmd_mux:src_channel -> Onchip_SRAM_s1_cmd_width_adapter:in_channel
	...
	wire          onchip_sram_s1_cmd_width_adapter_src_valid;                                                // Onchip_SRAM_s1_cmd_width_adapter:out_valid -> Onchip_SRAM_s1_agent:cp_valid
	wire  [101:0] onchip_sram_s1_cmd_width_adapter_src_data;                                                 // Onchip_SRAM_s1_cmd_width_adapter:out_data -> Onchip_SRAM_s1_agent:cp_data
	wire          onchip_sram_s1_cmd_width_adapter_src_ready;                                                // Onchip_SRAM_s1_agent:cp_ready -> Onchip_SRAM_s1_cmd_width_adapter:out_ready
	wire    [0:0] onchip_sram_s1_cmd_width_adapter_src_channel;                                              // Onchip_SRAM_s1_cmd_width_adapter:out_channel -> Onchip_SRAM_s1_agent:cp_channel
	wire          onchip_sram_s1_cmd_width_adapter_src_startofpacket;                                        // Onchip_SRAM_s1_cmd_width_adapter:out_startofpacket -> Onchip_SRAM_s1_agent:cp_startofpacket
	wire          onchip_sram_s1_cmd_width_adapter_src_endofpacket;                                          // Onchip_SRAM_s1_cmd_width_adapter:out_endofpacket -> Onchip_SRAM_s1_agent:cp_endofpacket
	wire          router_001_src_valid;                                                                      // router_001:src_valid -> Onchip_SRAM_s1_rsp_width_adapter:in_valid
	wire  [101:0] router_001_src_data;                                                                       // router_001:src_data -> Onchip_SRAM_s1_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                                                      // Onchip_SRAM_s1_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [0:0] router_001_src_channel;                                                                    // router_001:src_channel -> Onchip_SRAM_s1_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                                              // router_001:src_startofpacket -> Onchip_SRAM_s1_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                                                // router_001:src_endofpacket -> Onchip_SRAM_s1_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s1_rsp_width_adapter_src_valid;                                                // Onchip_SRAM_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire   [74:0] onchip_sram_s1_rsp_width_adapter_src_data;                                                 // Onchip_SRAM_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          onchip_sram_s1_rsp_width_adapter_src_ready;                                                // rsp_demux:sink_ready -> Onchip_SRAM_s1_rsp_width_adapter:out_ready
	wire    [0:0] onchip_sram_s1_rsp_width_adapter_src_channel;                                              // Onchip_SRAM_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire   [33:0] onchip_sram_s1_agent_rdata_fifo_src_data;                                                  // Onchip_SRAM_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	...
	altera_merlin_slave_agent #(
		...
		.cp_ready                (onchip_sram_s1_cmd_width_adapter_src_ready),         //              cp.ready
		.cp_valid                (onchip_sram_s1_cmd_width_adapter_src_valid),         //                .valid
		.cp_data                 (onchip_sram_s1_cmd_width_adapter_src_data),          //                .data
		.cp_startofpacket        (onchip_sram_s1_cmd_width_adapter_src_startofpacket), //                .startofpacket
		.cp_endofpacket          (onchip_sram_s1_cmd_width_adapter_src_endofpacket),   //                .endofpacket
		.cp_channel              (onchip_sram_s1_cmd_width_adapter_src_channel),       //                .channel
	...
	Computer_System_mm_interconnect_5_router_001 router_001 (
	...
	Computer_System_mm_interconnect_5_cmd_demux rsp_demux (
		.clk                (System_PLL_sys_clk_clk),                             //       clk.clk
		.reset              (Onchip_SRAM_reset1_reset_bridge_in_reset_reset),     // clk_reset.reset
